...
# Output directory name — override with GRAPHIFY_OUT env var for custom output locations
...
_SKIP_DIRS = {
    ...
    ".tox", ".eggs", "*.egg-info",
    # Note: graphify output dir is checked dynamically in _is_noise_dir
}
...
def _is_noise_dir(part: str) -> bool:
    ...
    # Check dynamic graphify output dir (#524)
    if part == os.environ.get("GRAPHIFY_OUT", "graphify-out"):
        return True
