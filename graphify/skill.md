...
```bash
# Parse --out flag if provided (must come before OUTPUT_DIR is used)
OUTPUT_DIR="graphify-out"
for arg in "$@"; do
    case "$arg" in
        --out=*) OUTPUT_DIR="${arg#*=}" ;;
        --out)   shift; OUTPUT_DIR="$1" ;;
    esac
done
...
Before the merge step, save the old graph: `cp graphify-out/graph.json $OUTPUT_DIR/.graphify_old.json`
