...
result = json.loads(open('graphify-out/.graphify_incremental.json').read()) if Path('$GRAPHIFY_OUT/.graphify_incremental.json').exists() else {}
...
Path('$GRAPHIFY_OUT/.graphify_extract.json').write_text(json.dumps(merged_out))
