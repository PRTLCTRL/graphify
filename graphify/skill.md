...
/graphify <path> --output-dir docs/graph              # specify custom output directory (default: graphify-out)
...
**Note:** You can also use the `GRAPHIFY_OUT` environment variable to set the output directory globally.
